...
class ApplyCancelButtons extends React.Component {
  ...
  getMaxDateBox() {
    if (this.props.maxDate && this.props.showMaxDateLabel) {
  ...
  getStartEndDateTime() {
    if (this.props.startDate && this.props.endDate) {
      ...
      let selectedStartDate = (this.props.startDate && this.props.startDate ? this.props.startDate.format(this.props.local.format) : "" )
      let selectedEndDate = (this.props.endDate && this.props.endDate ? this.props.endDate.format(this.props.local.format) : "")
      return (
